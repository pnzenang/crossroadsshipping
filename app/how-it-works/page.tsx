            ...
            <div className='flex gap-4 min-[960px]:max-w-md'>
              ...
              <div className='flex flex-col justify-center gap-5 px-0 min-[960px]:gap-6 min-[960px]:px-4 min-[960px]:py-4'>
                ...
                <p className='text-sm text-muted-foreground min-[960px]:text-base'>
                  ...
                  can send and does not represent a complete list of what you
                  can send, but only an idea you can use to build your package.
                </p>
              </div>
            </div>
            <img
          ...
          <div className='flex flex-col items-center justify-between min-[960px]:flex-row min-[960px]:gap-10'>
            <div className='flex gap-4 min-[960px]:max-w-md'>
              ...
              <div className='flex flex-col justify-center gap-5 px-0 min-[960px]:gap-6 min-[960px]:px-4 min-[960px]:py-4'>
                ...
                <p className='text-sm text-muted-foreground min-[960px]:text-base'>
                  Select your desire container or product to send, click on it
                  and selct the desired quantity and add to your package. Make
                  sure not to mix the two mode of shipping in the same package
                </p>
              </div>
            </div>
            <img
